def dataTypeParse(root, std):
    """
    Helper function for parsing data type
    :param root: ElementTree doc root
    :param std: Metadata standard being used
    """
    ...
    if std == "FGDC":
        ...
        print "No metadata standard provided!"
